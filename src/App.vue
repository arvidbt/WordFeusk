...
<template>
  <div class="wrapper">
    ...
    <div class="title-container">
      ...
      <!-- <button class="search-button" @click="toggleHelp()">INFO</button> -->
      <!-- <button style="margin-right: 60px;" class="search-button" @click="toggleAdvancedMode()">A.SÖK</button> -->
